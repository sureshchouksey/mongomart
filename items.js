...
function ItemDAO(database) {
    ...
    this.getItems = function(category, page, itemsPerPage, callback) {
         ...
         */
         ...
         this.db.collection("item").find({"category":category}).sort({_id:1}).skip(page*itemsPerPage).limit(itemsPerPage).
    ...
    this.searchItems = function(query, page, itemsPerPage, callback) {
         ...
         *
         */
         this.db.collection("item").createIndex({title:"text",description:"text",slogan:"text"});
    ...
    this.getItem = function(itemId, callback) {
       ...
       var item= this.db.collection("item").find({_id:itemId}).toArray(function(err,doc){
            callback(doc[0]);
       });
    ...
    this.addReview = function(itemId, comment, name, stars, callback) {
        ...
        //r doc = this.createDummyItem();
       //oc.reviews = [reviewDoc];
        ...
        this.db.collection('item').update({"_id":itemId},
            {$push:{reviews:{"name":name,"comment":comment,"stars":stars,"date":Date.now()}}},
            function(err,doc){
