...
function CartDAO(database) {
    ...
    this.getCart = function(userId, callback) {
        ...
        */
        ...
        this.db.collection('cart').find({"userId":userId},{_id:0,items:1}).toArray(function(err,docs){
           
            userCart.items=docs[0].items;
    ...
    this.itemInCart = function(userId, itemId, callback) {
         ...
         *
         */
         console.log("Inside the cart",userId,itemId);
         this.db.collection('cart').find({"userId":userId},{items:{$elemMatch:{"_id":itemId}}},{"_id":0,"items.$":1}).toArray(function(err,docs){
            console.log("After the Add Cart",docs);

            if(docs[0].items && docs[0].items.length==1)
            {
